...
public class ArrowTowerBulletLevelManager {
    ...
    private static final int RESOURCE_ID_LEVEL_1 = R.drawable.stonesprites;

    private static final int ATTACK_LEVEL_2 = 8;
    private static final int SPEED_LEVEL_2 = 30;
    private static final int EFFECT_LEVEL_2 = 0;
    ...
    private static final int RESOURCE_ID_LEVEL_2 = R.drawable.stonesprites;

    private static final int ATTACK_LEVEL_3 = 16;
    private static final int SPEED_LEVEL_3 = 40;
    private static final int EFFECT_LEVEL_3 = 0;
    ...
    private static final int RESOURCE_ID_LEVEL_3 = R.drawable.arrowsprites;
