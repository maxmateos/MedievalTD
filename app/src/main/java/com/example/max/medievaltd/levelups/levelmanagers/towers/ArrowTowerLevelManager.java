...
public class ArrowTowerLevelManager {

    private static final int FREQUENCY_LEVEL_1 = 300;
    ...
    private static final int RESOURCE_ID_LEVEL_1 = R.drawable.arrowlvl1;

    private static final int FREQUENCY_LEVEL_2 = 400;
    private static final int RANGE_LEVEL_2 = 2;
    private static final int WIDTH_LEVEL_2 = 100;
    private static final int HEIGHT_LEVEL_2 = 103;
    private static final int FRAMES_LEVEL_2 = 1;
    private static final int RESOURCE_ID_LEVEL_2 = R.drawable.arrowlvl2;

    private static final int FREQUENCY_LEVEL_3 = 500;
    private static final int RANGE_LEVEL_3 = 3;
    private static final int WIDTH_LEVEL_3 = 100;
    private static final int HEIGHT_LEVEL_3 = 106;
    private static final int FRAMES_LEVEL_3 = 1;
    private static final int RESOURCE_ID_LEVEL_3 = R.drawable.arrowlvl3;
