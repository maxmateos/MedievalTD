...
public class SnowTowerLevelManager {
    ...
    private static final int RESOURCE_ID_LEVEL_1 = R.drawable.snowlvl1;

    private static final int FREQUENCY_LEVEL_2 = 600;
    private static final int RANGE_LEVEL_2 = 2;
    private static final int WIDTH_LEVEL_2 = 100;
    private static final int HEIGHT_LEVEL_2 = 106;
    private static final int FRAMES_LEVEL_2 = 1;
    private static final int RESOURCE_ID_LEVEL_2 = R.drawable.snowlvl2;

    private static final int FREQUENCY_LEVEL_3 = 900;
    private static final int RANGE_LEVEL_3 = 2;
    ...
    private static final int RESOURCE_ID_LEVEL_3 = R.drawable.snowlvl3;
